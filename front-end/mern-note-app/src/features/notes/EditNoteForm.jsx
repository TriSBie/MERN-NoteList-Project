...
//this section will update data also delete note
const EditNoteForm = ({ note, users }) => {
    ...
    const [userId, setUserId] = useState(note.user) //getID of user owns note
    ...
    const onSaveNoteClicked = async (e) => {
        if (canSave) {
            await updateNote({
                id: note.id, user: userId, title, text, completed,
            })
        }
    }
